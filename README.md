...
- 사진첩 탭 (탭 이름도 바꿀 수 있음)
- 오에카키. 옛날 BBS 처럼 방문자가 브라우저에서 그림을 그려 남깁니다. 그림을 누르면 크게 보이고 댓글을 달 수 있습니다. 주인장은 그림을 가릴 수 있습니다. Firebase 연결 시에만 나타납니다
...
오에카키 그림도 같은 정책입니다. 읽기는 누구나, 남기기는 로그인한 사람만, 삭제는 작성자 본인과 주인장. 그림은 고칠 수 없고 지우고 다시 그립니다.
